...
Explain normalization and list the different normal forms.
...
How does a Common Table Expression (CTE) work and how is it different from a subquery?
What are the advantages and disadvantages of using stored procedures?
How can you detect and prevent SQL injection?
What is the difference between EXISTS and IN operators in SQL?
How does indexing work and how can you identify slow queries?
What is the use of the EXPLAIN or QUERY PLAN statement?
What are aggregate functions and how are GROUP BY and HAVING used?
What is a composite key and when should it be used?
What is a materialized view and how does it differ from a regular view?
How do you handle NULL values in queries and constraints?
What is the difference between scalar functions and table-valued functions?
How would you design a schema for a multi-tenant application in SQL?
Basic
1. What is .NET?
...
Follow Microsoft’s .NET Blog → https://devblogs.microsoft.com/dotnet/
